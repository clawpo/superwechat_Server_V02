...
public interface I {
	...
	int MSG_REGISTER_UPLOAD_AVATAR_SUCCESS			=		103;							//上传头像成功
	int MSG_REGISTER_FAIL							=		104;							//注册失败
	int MSG_UNREGISTER_SUCCESS						=  		105;							//注册成功
	int MSG_UNREGISTER_FAIL							=		106;							//注册失败
	...
	int MSG_GROUP_UPDATE_NAME_FAIL					=		308;							//群组名称修改失败
	int MSG_GROUP_DELETE_MEMBER_SUCCESS				=		309;							//删除群组成员成功
	int MSG_GROUP_DELETE_MEMBER_FAIL				=		310;							//删除群组成员失败
	int MSG_GROUP_DELETE_SUCCESS					=		311;							//删除群组成功
	int MSG_GROUP_DELETE_FAIL						=		312;							//删除群组失败
